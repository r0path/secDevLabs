...
func InitDatabase() error {
	...
	queryCreate := fmt.Sprint("CREATE TABLE IF NOT EXISTS Users (ID int NOT NULL AUTO_INCREMENT, Username varchar(64) NOT NULL UNIQUE, Password varchar(255) NOT NULL, PRIMARY KEY (ID))")
